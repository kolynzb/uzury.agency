...
const DefaultHeader = ({ transparent, headerTop,  extraClass }:Props) => {
  const [toggle, setToggle] = useState(false);
  return (
    <div
      className={cn("mil-top-position mil-fixed ",extraClass)}
    >
      {headerTop && (
      ...
      <div
        ...
        className={cn("mil-top-panel",{
          "mil-top-panel-transparent mil-animated" :transparent
        })}
      ...
      >
        ...
        <div className="container">
          ...
          {/* mobile menu button */}
          <div
              className={cn("mil-menu-btn  ",{"mil-active" :toggle})}
